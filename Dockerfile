...
RUN apt-get update && apt-get install -y openssl ca-certificates libreoffice-writer libreoffice-calc libreoffice-impress libreoffice-draw tesseract-ocr tesseract-ocr-eng poppler-utils && rm -rf /var/lib/apt/lists/*
WORKDIR /app
